...
const MainBanner = () => {
  return (
    <div className='relative '>
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-end md:justify-center md:items-start pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
          ...
          <div className='flex item-center mt-6 font-medim'>
