                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=>{e.stopPropagation();} } className="text-primary ">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1  border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded text-primary bg-primary/10 font-medium cursor-pointer" onClick={() => addToCart(product._id)} >
